...
/**
 * Common styles for the pmadarktheme theme
 *
...
#initials_table a.active {
    ...
    <?php echo $_SESSION['PMA_Theme']->getCssGradient('333333', '111111'); ?>
}
...
button[type=submit]:not(.mult_submit):focus,
input[type=reset]:hover,
input[type=reset]:focus,
input[name=submit_reset]:hover,
input[name=submit_reset]:focus,
input.button:hover,
input.button:focus {
    position: relative;
...
input.button:active {
    position: relative;
    <?php echo $_SESSION['PMA_Theme']->getCssGradient('222', '111'); ?>
    box-shadow: 0 1px 6px -2px #999 inset;
    text-shadow: none;
}
...
table tbody:first-of-type tr:not(.nopointer):hover a,
table tbody:first-of-type tr:not(.nopointer):hover th a,
.hover:not(.nopointer) a {
    color: <?php echo $GLOBALS['cfg']['BrowseMarkerColor']; ?>;
}
<?php endif; ?>
...
#sectionlinks {
    ...
    -webkit-box-shadow: 0 1px 1px #111 inset;
    -moz-box-shadow: 0 1px 1px #111 inset;
}
#sectionlinks a,
.buttonlinks a,
a.button {
...
.config-form ul.tabs li a:focus,
...
.config-form span.checkbox:focus,
.config-form span.checkbox:hover {
...
.config-form span.checkbox.custom:focus,
.config-form span.checkbox.custom:hover {
    background: rgba(255,255,255,0.1);
    border: 1px rgba(255,255,255,0.1) solid;
}
...
.cEdit .edit_box_posting {
    background: #111 url(<?php echo $_SESSION['PMA_Theme']->getImgPath('ajax_clock_small.gif');?>) no-repeat right center;
...
#pma_console .content .CodeMirror {
    color: #333;
}
#pma_console .content .CodeMirror-cursor {
    border-color: #333;
}
