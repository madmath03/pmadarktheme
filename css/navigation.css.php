...
#pma_navigation {
    ...
    <?php echo $left; ?>: 0;
    height: 100%;
    background: url(./themes/pmadarktheme/img/left_nav_bg.png) repeat-y right 0 <?php echo $GLOBALS['cfg']['NaviBackground']; ?>;
...
#pma_navigation_db_select select {
    background: url("./themes/pmadarktheme/img/select_bg.png") repeat scroll 0 0;
